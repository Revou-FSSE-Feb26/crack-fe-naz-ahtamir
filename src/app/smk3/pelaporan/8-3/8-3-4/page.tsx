      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f15a22]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6 flex-wrap">
            ...
            <Link href="/smk3/pelaporan" className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#c5c0bb] hover:text-[#f15a22] transition-colors">
              Elemen 8
            </Link>
            <div className="text-[#c5c0bb]">/</div>
            <Link href="/smk3/pelaporan/8-3" className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#c5c0bb] hover:text-[#f15a22] transition-colors">
              Sub-Elemen 8.3
            </Link>
            <div className="text-[#c5c0bb]">/</div>
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f15a22]">8.3.4</div>
          </div>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="font-barlow-condensed font-extrabold text-white uppercase leading-[0.95] tracking-[-0.01em] text-[clamp(24px,4vw,40px)]">
                Penanggung Jawab Tindak Perbaikan
              </h1>
            </div>
          </div>
        </div>
          ...
          {showForm && (
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <SMK3DataForm
                ...
                subSubElementTitle="Penanggung Jawab Tindak Perbaikan"
