...
const subElements = [
  { id: "4.1", title: "Persetujuan & Pengeluaran Dokumen", description: "Proses approval dan distribusi dokumen K3" },
  { id: "4.2", title: "Perubahan & Modifikasi Dokumen", description: "Kontrol perubahan dan revisi dokumen" },
];
      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f7941d]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f7941d]">Elemen 4</div>
          </div>
          <div className="flex items-center gap-4 mb-4">
            <div className="bg-[#f7941d] w-16 h-16 flex items-center justify-center text-white font-barlow-condensed font-extrabold text-[24px]">4</div>
            <div><h1 className="font-barlow-condensed font-extrabold text-white uppercase leading-[0.95] tracking-[-0.01em] text-[clamp(32px,5vw,56px)]">Pengendalian<br />Dokumen</h1></div>
          </div>
          <p className="text-[#c5c0bb] text-[14px] max-w-3xl">Manajemen dan kontrol dokumen K3 termasuk approval, distribusi, dan revisi</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f7941d] flex items-center gap-3 mb-4">
              <span>2 Sub-Elemen</span><span className="w-10 h-0.5 bg-[#f7941d]"></span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {subElements.map((subElement) => (
              <Link key={subElement.id} href={`/smk3/dokumen/${subElement.id.replace(".", "-")}`}
