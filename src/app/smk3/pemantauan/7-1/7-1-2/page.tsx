      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f15a22]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6 flex-wrap">
            ...
            <div className="text-[#c5c0bb]">/</div>
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f15a22]">7.1.2</div>
          </div>
          ...
          {showForm && (
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <SMK3DataForm
                ...
                subSubElementTitle="Kompetensi Petugas Inspeksi"
