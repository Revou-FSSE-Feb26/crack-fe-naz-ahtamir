...
export default function InspeksiSaranaPrasaranaPage() {
  ...
  const formConfig = getFormConfig("7.1.1-inspeksi-sarana-prasarana");
      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f15a22]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6 flex-wrap">
            ...
            <div className="text-[#c5c0bb]">/</div>
            <Link href="/smk3/pemantauan/7-1/7-1-1" className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#c5c0bb] hover:text-[#f15a22] transition-colors">
              7.1.1
            </Link>
            <div className="text-[#c5c0bb]">/</div>
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#3a86ff]">Inspeksi Sarana Prasarana</div>
          </div>

          {/* Title Section */}
          <div className="flex items-start gap-4 mb-4">
            <div className="bg-[#3a86ff] px-4 py-2 flex items-center justify-center text-white font-barlow-condensed font-extrabold text-[18px]">
              7.1.1.2
            </div>
          ...
          <p className="text-[#c5c0bb] text-[14px] max-w-3xl">
            Pemeriksaan berkala terhadap fasilitas dan infrastruktur untuk memastikan keselamatan dan kenyamanan kerja
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <h2 className="font-barlow-condensed font-extrabold text-[#231f20] uppercase text-[clamp(24px,3vw,32px)]">
              Kelola Data Inspeksi Sarana Prasarana
            </h2>
            <button
              onClick={() => {
                setEditData(null);
              ...
              className="px-6 py-3 bg-[#3a86ff] text-white font-barlow-condensed font-bold text-sm tracking-wider uppercase rounded hover:bg-[#2a6add] transition-colors flex items-center gap-2"
            >
          ...
          {showForm && (
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <SMK3DataForm
                ...
                subSubElementTitle="Inspeksi Sarana Prasarana"
