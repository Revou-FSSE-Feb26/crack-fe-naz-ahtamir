...
export default function InspeksiAPDPage() {
  ...
  const formConfig = getFormConfig("7.1.1-inspeksi-apd");
      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f15a22]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6 flex-wrap">
            ...
            <div className="text-[#c5c0bb]">/</div>
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#e76f51]">Inspeksi APD</div>
          </div>

          {/* Title Section */}
          <div className="flex items-start gap-4 mb-4">
            <div className="bg-[#e76f51] px-4 py-2 flex items-center justify-center text-white font-barlow-condensed font-extrabold text-[18px]">
              7.1.1.4
            </div>
          ...
          <p className="text-[#c5c0bb] text-[14px] max-w-3xl">
            Pemeriksaan kelayakan dan kondisi Alat Pelindung Diri (APD) untuk memastikan efektivitasnya
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#e76f51] text-white font-barlow-condensed font-bold text-sm tracking-wider uppercase rounded hover:bg-[#c85a3e] transition-colors flex items-center gap-2"
            >
          ...
          {showForm && (
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <SMK3DataForm
                ...
                subSubElementTitle="Inspeksi APD"
