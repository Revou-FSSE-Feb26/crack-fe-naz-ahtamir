...
const subElements = [
  { id: "7.1", title: "Pemeriksaan Bahaya (Inspeksi)", description: "Inspeksi rutin untuk identifikasi bahaya" },
  { id: "7.2", title: "Pemantauan/Pengukuran Lingkungan Kerja", description: "Monitoring kondisi lingkungan kerja" },
  { id: "7.3", title: "Peralatan Pemeriksaan, Pengukuran & Pengujian (kalibrasi)", description: "Kalibrasi dan pemeliharaan alat ukur" },
  { id: "7.4", title: "Pemantauan Kesehatan Tenaga Kerja (MCU)", description: "Medical check-up dan health surveillance" },
];
      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f15a22]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f15a22]">Elemen 7</div>
          </div>
          <div className="flex items-center gap-4 mb-4">
            <div className="bg-[#f15a22] w-16 h-16 flex items-center justify-center text-white font-barlow-condensed font-extrabold text-[24px]">7</div>
            <div><h1 className="font-barlow-condensed font-extrabold text-white uppercase leading-[0.95] tracking-[-0.01em] text-[clamp(32px,5vw,56px)]">Standar<br />Pemantauan</h1></div>
          </div>
          <p className="text-[#c5c0bb] text-[14px] max-w-3xl">Standar monitoring dan pengawasan K3 termasuk inspeksi, pengukuran lingkungan, dan kesehatan kerja</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f15a22] flex items-center gap-3 mb-4">
              <span>4 Sub-Elemen</span><span className="w-10 h-0.5 bg-[#f15a22]"></span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {subElements.map((subElement) => (
              <Link key={subElement.id} href={`/smk3/pemantauan/${subElement.id.replace(".", "-")}`}
