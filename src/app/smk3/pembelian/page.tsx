...
const subElements = [
  { id: "5.1", title: "Spesifikasi Pembelian Barang/Jasa", description: "Persyaratan K3 dalam spesifikasi pembelian" },
  { id: "5.2", title: "Verifikasi Barang/Jasa yang Dibeli", description: "Proses verifikasi kesesuaian dengan standar K3" },
  { id: "5.3", title: "Pengendalian Barang/Jasa dari Pelanggan", description: "Kontrol barang/jasa yang disediakan pelanggan" },
  { id: "5.4", title: "Kemampuan Telusur Produk", description: "Sistem traceability produk untuk K3" },
];
      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f15a22]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="font-barlow-condensed text-[11px] font-bold tracking-[0.2em] uppercase text-[#f15a22]">Elemen 5</div>
          </div>
          <div className="flex items-center gap-4 mb-4">
            <div className="bg-[#f15a22] w-16 h-16 flex items-center justify-center text-white font-barlow-condensed font-extrabold text-[24px]">5</div>
            <div><h1 className="font-barlow-condensed font-extrabold text-white uppercase leading-[0.95] tracking-[-0.01em] text-[clamp(32px,5vw,56px)]">Pembelian &<br />Pengendalian Produk</h1></div>
          </div>
          <p className="text-[#c5c0bb] text-[14px] max-w-3xl">Kontrol pembelian dan produk terkait K3 termasuk spesifikasi, verifikasi, dan traceability</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {subElements.map((subElement) => (
              <Link key={subElement.id} href={`/smk3/pembelian/${subElement.id.replace(".", "-")}`}
