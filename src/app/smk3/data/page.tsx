...
const subElements = [
  { id: "10.1", title: "Pengumpulan & Pengarsipan Catatan K3", description: "Record keeping dan document archiving" },
  { id: "10.2", title: "Analisis Data & Laporan Kinerja K3", description: "Data analysis dan performance reporting" },
];
      ...
      <div className="bg-[#231f20] py-[calc(72px+64px)] px-5 md:px-10 border-b-[4px] border-b-[#f7941d]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="bg-[#f7941d] w-16 h-16 flex items-center justify-center text-white font-barlow-condensed font-extrabold text-[24px]">10</div>
            <div><h1 className="font-barlow-condensed font-extrabold text-white uppercase leading-[0.95] tracking-[-0.01em] text-[clamp(32px,5vw,56px)]">Pengumpulan &<br />Penggunaan Data</h1></div>
          </div>
          <p className="text-[#c5c0bb] text-[14px] max-w-3xl">Koleksi dan analisis data K3 untuk pelaporan kinerja dan improvement</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {subElements.map((subElement) => (
              <Link key={subElement.id} href={`/smk3/data/${subElement.id.replace(".", "-")}`}
