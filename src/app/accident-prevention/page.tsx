...
// ─── Konfigurasi field untuk Accident Prevention ──────────────────────────────
const CATEGORY: RecordCategory = 'accident-prevention';

const FIELDS: FormField[] = [
  {
    key: 'jenisInsiden',
    label: 'Jenis Insiden / Bahaya',
    type: 'select',
    required: true,
    options: [
      { label: 'Near Miss', value: 'Near Miss' },
      { label: 'Kecelakaan Ringan', value: 'Kecelakaan Ringan' },
      { label: 'Kecelakaan Berat', value: 'Kecelakaan Berat' },
      { label: 'Bahaya Potensial', value: 'Bahaya Potensial' },
  ...
  },
  {
    ...
    type: 'text',
    required: true,
    placeholder: 'Contoh: Area Furnace 2, Warehouse B',
  },
  {
    key: 'tanggalKejadian',
  ...
  {
    key: 'tindakanPencegahan',
    label: 'Tindakan Pencegahan',
    type: 'textarea',
    required: true,
    placeholder: 'Jelaskan tindakan yang diambil untuk mencegah kejadian berulang...',
  },
  {
    key: 'penanggungJawab',
    label: 'Penanggung Jawab',
    type: 'text',
    placeholder: 'Nama supervisor / PIC',
  },
  {
    key: 'statusTindakan',
...
// ─── Komponen utama ───────────────────────────────────────────────────────────
export default function AccidentPreventionPage() {
  const { user } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-[#f1f0ee]">
      ...
      <div className="bg-[#231f20] px-6 md:px-10 py-8 border-b-[3px] border-b-[#f15a22]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-[#8a8580] text-[13px] mt-1">
            Catat dan kelola insiden, near miss, dan tindakan pencegahan kecelakaan
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Cari record accident prevention..."
      ...
      <RecordFormModal
        ...
        fields={FIELDS}
        title={editTarget ? 'Edit Record Accident Prevention' : 'Tambah Record Accident Prevention'}
