...
// ─── Konfigurasi field untuk Safety Compliance ────────────────────────────────
const CATEGORY: RecordCategory = 'safety-compliance';

const FIELDS: FormField[] = [
  {
    key: 'namaProgram',
    label: 'Nama Program / Kebijakan',
    type: 'text',
    required: true,
    placeholder: 'Contoh: Kebijakan K3 2025',
  },
  {
    key: 'nomorDokumen',
    label: 'Nomor Dokumen',
    type: 'text',
    placeholder: 'Contoh: K3-POL-001',
  },
  {
    key: 'tanggalBerlaku',
  ...
  return (
    <div className="min-h-screen bg-[#f1f0ee]">
      ...
      <div className="bg-[#231f20] px-6 md:px-10 py-8 border-b-[3px] border-b-[#f15a22]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-[#8a8580] text-[13px] mt-1">
            Kelola kepatuhan kebijakan, dokumen, dan regulasi K3
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Cari record safety compliance..."
      ...
      <RecordFormModal
        ...
        fields={FIELDS}
        title={editTarget ? 'Edit Record Safety Compliance' : 'Tambah Record Safety Compliance'}
        initialValues={
          editTarget
      ...
      {toast && (
        <div
          className={`fixed bottom-6 right-6 z-[600] flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-lg text-[14px] font-medium transition-all ${
            toast.type === 'success'
